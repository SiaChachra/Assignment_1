...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  // Create a new order
  $result = $database->create($name, $email, $address, $size, $toppings, $payment_method, $special_instructions);
    ...
    <?php if ($latestOrder) : ?>
      <table>
        ...
        <tr>
          ...
          <td><?php echo $latestOrder['paymentmethod']; ?></td>
